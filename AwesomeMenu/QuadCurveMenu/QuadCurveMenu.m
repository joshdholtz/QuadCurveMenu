...
{
    [self initWithFrame:frame menus:aMenusArray location:CGPointMake(kQuadCurveMenuDefaultStartPointX, kQuadCurveMenuDefaultStartPointY)];
    return self;
}
